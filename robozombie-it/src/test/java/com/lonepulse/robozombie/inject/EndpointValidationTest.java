...
public class EndpointValidationTest {
	...
	public void setUp() throws Exception {
		...
		missingEndpointAnnotationExceptionClass = (Class<Throwable>) 
			Class.forName("com.lonepulse.robozombie.validator.MissingEndpointAnnotationException");
		
		missingEndpointHostExceptionClass = (Class<Throwable>) 
			Class.forName("com.lonepulse.robozombie.validator.MissingEndpointHostException");
	}
