...
final class XmlResponseParser extends AbstractDeserializer<Object> {
	...
	.append("To enable XML response parsing with @Deserializer(ParserType.XML) ")
	...
	.append("\n\nFailed to initialize XmlResponseParser; use of @Deserializer(ParserType.XML) is disabled.\n")
