...
class ObjectResponseParser extends AbstractResponseParser<Object> {
	 ...
	 * 
	 * @see AbstractResponseParser#parse(HttpResponse, com.lonepulse.robozombie.processor.ProxyInvocationConfiguration)
	 */
	@Override
	...
	/**
	 * @see com.lonepulse.robozombie.processor.AbstractResponseParser#getType()
	 */
	@Override
